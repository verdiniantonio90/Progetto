sap.ui.define([
  ...
  return Controller.extend("my.application.controller.BaseController", {
    ...
    createAnagDoc: function (anagrafica, documenti) {
      ...
      const raw = JSON.stringify({
        "anagrafica": {
          ...
          "nome": "Luigi",
          "cognome": "fava",
          "indirizzo": "via trevi 34",
          "cap": "00100",
          "dataNascita": "04/10/1990",
          "telefono": "06308308",
          "cellulare": "3588789032",
          "email": "prova1@mail.com",
          "pec": "pec1@mail.com",
          "cf": "afgijuiffegh",
          "p_iva": "01334947857"
        },
      ...
      fetch("http://localhost:4000/CreateAnagDoc", requestOptions)
